...
depositan un número par de huevos. Imagina que tienes una lista de números enteros en
la que cada número representa la cantidad de huevos puestos por un dinosaurio en el parque.

Importante: Solo se consideran los huevos de los dinosaurios carnívoros (T-Rex) aquellos números que son pares.

Objetivo:
Escribe una función en Python que reciba una lista de números enteros y devuelva la suma total de los huevos que
...
# def sumar_pares (lista_de_huevos)-> int :
#     acumulador=0
#     for huevos in lista_de_huevos:
#         if huevos % 2 == 0:
#             acumulador+=huevos
#     return acumulador

# lista =[3,5,4,8,6,7,5,9,2,2]
# print(sumar_pares(lista))
